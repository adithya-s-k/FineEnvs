...
| **04** | **[Data Agent](./04-data-agent/)** | Give an agent a question and a directory of real tables, and train it on what it actually did — the engine's own token ids, not a re-rendered guess at them. | 2 | 1 | 0 | 🚧 wip |
<!-- END:projects -->
